                        ...
                        <div class="card-body table-responsive">
                            <form method="post" action="/managekuliah/managematkul/{{ $matkul->kode_matkul }}/{{ $tahun_ajaran }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="kode_matkul" type="text" class="form-control @error('kode_matkul') is-invalid @enderror" id="kode_matkul" placeholder="Kode matkul" value="{{ rtrim($matkul->kode_matkul, 'TP') }}">
                                    @error('kode_matkul')
                                ...
                                <select name="jumlah_sks" class="form-control select2bs4 @error('jumlah_sks') is-invalid @enderror" style="width: 100%;">
                                    <option @if($matkul->sks == '1') selected @endif value="1">1</option>
                                ...
                                <div class="form-group">
                                <label>Jenis</label>
                                <select name="jenis" class="form-control select2bs4 @error('jenis') is-invalid @enderror" style="width: 100%;">
                                    <option value="Tatap Muka" {{ $matkul->jenis == 'Tatap Muka' ? 'selected' : '' }}>Tatap Muka</option>
                                    <option value="Praktikum" {{ $matkul->jenis == 'Praktikum' ? 'selected' : '' }}>Praktikum</option>
                                </select>
                                @error('jenis')
                                <div class="invalid-feedback">
                                    {{$message}}
