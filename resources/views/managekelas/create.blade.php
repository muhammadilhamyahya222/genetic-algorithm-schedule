                ...
                <div class="card text-choThem">
                    ...
                    <div class="card-body table-responsive">
                        <form method="post" action="/managekuliah/managekelas">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="matkul[]" multiple id="select-matkul" disabled="disabled" class="form-control select2bs4 @error('matkul') is-invalid @enderror">
                                            <option value="" class="default-select">-- Mata Kuliah --</option>
                                        </select>                                        
                                        @error('matkul')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                    ...
                                    <div class="col-md-6">
                                        <label>Dosen Pengajar</label>
                                            <select name="dosen_pengajar[]" id="select-dosen" disabled="disabled" class="form-control select2bs4 @error('dosen_pengajar') is-invalid @enderror" multiple>
                            ...
                            <div class="form-group">
                                <label>Kelas</label>
                                <select name="kelas[]" multiple id="select-kelas" class="form-control select2bs4 @error('kelas') is-invalid @enderror" style="width: 100%;">
                                    <option disabled class="default-select-kelas">-- Pilih Kelas --</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kapasitas_kelas" class="form-control select2bs4 @error('kapasitas_kelas') is-invalid @enderror" style="width: 100%;">
                                    @foreach(range('1','100') as $n):
                                        <option @if($n == 50) selected @endif value="{{ $n }}">{{ $n }}</option>
                                    @endforeach
                                </select>
