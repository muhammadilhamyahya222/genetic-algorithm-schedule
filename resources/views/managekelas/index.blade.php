                        ...
                        <table class="table table-hover text-nowrap text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td scope="row">{{ ucwords($k->nama_matkul) }} - {{ $k->jenis }}</td>
                                    {{-- <td scope="row">{{ucwords($k->jenis)}}</td> --}}
                                    <td scope="row">
                                        @php
                                            // Misalnya $k->dosen adalah array dosen terkait dengan kelas
                                            $dosenList = explode(';', $k->nama_dosen);  // Jika dosen dipisahkan dengan koma dalam satu kolom
                                        @endphp
                                    ...
                                    <td>{{ ucwords(\App\Models\Prodi::where('kode_prodi', $k->kode_prodi)->first()->kode_prodi)}}</td>
